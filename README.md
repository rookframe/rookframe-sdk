# Rookframe SDK Authoring Kit 0.22.0
...
func _plugging() -> void:
    plug("rookframe/rookframe-sdk", {"tag": "v0.22.0", "include": ["addons/rookframe_sdk"]})
...
SDK 0.22.0 includes the production admission rules for stock
