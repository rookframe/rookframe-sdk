# Rookframe SDK Authoring Kit 0.13.1
...
func _plugging() -> void:
    plug("rookframe/rookframe-sdk", {"tag": "v0.13.1", "include": ["addons/rookframe_sdk"]})
...
SDK 0.13.1 includes the production admission rules for stock
