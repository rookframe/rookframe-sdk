# Rookframe SDK Authoring Kit 0.17.0

Author ordinary Godot Packages for SDK Edition 2029 (revisions 1–9). The kit also authors 2027 revisions 1–7 and 2028 revisions 1–4;
...
func _plugging() -> void:
    plug("rookframe/rookframe-sdk", {"tag": "v0.17.0", "include": ["addons/rookframe_sdk"]})
...
SDK 0.17.0 includes the production admission rules for stock
