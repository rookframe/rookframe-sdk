...
def check_edition(edition: str, revision: int) -> None:
    if type(revision) is not int or not 1 <= revision <= SDK_EDITIONS.get(edition, 0):
        raise AuthoringError("SDK.REVISION: This kit authors 2029 revisions 1–20, 2027 revisions 1–7 and 2028 revisions 1–4. Use SDK 0.7.0 to author 2027:8 or 2028:5, or migrate integrations to 2029:1.")
